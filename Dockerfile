...
RUN /docker-apt-get-install.sh fonts-cabin
RUN /docker-apt-get-install.sh fonts-comfortaa
RUN /docker-apt-get-install.sh fonts-crosextra-caladea
RUN /docker-apt-get-install.sh fonts-crosextra-carlito
RUN /docker-apt-get-install.sh fonts-dejavu-extra
RUN /docker-apt-get-install.sh fonts-ebgaramond
RUN /docker-apt-get-install.sh fonts-ebgaramond-extra
RUN /docker-apt-get-install.sh fonts-font-awesome
RUN /docker-apt-get-install.sh fonts-freefont-otf
RUN /docker-apt-get-install.sh fonts-freefont-ttf
RUN /docker-apt-get-install.sh fonts-gfs-artemisia
RUN /docker-apt-get-install.sh fonts-gfs-complutum
RUN /docker-apt-get-install.sh fonts-gfs-didot
RUN /docker-apt-get-install.sh fonts-gfs-neohellenic
RUN /docker-apt-get-install.sh fonts-gfs-olga
RUN /docker-apt-get-install.sh fonts-gfs-solomos
RUN /docker-apt-get-install.sh fonts-inconsolata
RUN /docker-apt-get-install.sh fonts-junicode
RUN /docker-apt-get-install.sh fonts-lato
RUN /docker-apt-get-install.sh fonts-linuxlibertine
RUN /docker-apt-get-install.sh fonts-lobster
RUN /docker-apt-get-install.sh fonts-lobstertwo
RUN /docker-apt-get-install.sh fonts-oflb-asana-math
RUN /docker-apt-get-install.sh fonts-sil-gentium
RUN /docker-apt-get-install.sh fonts-sil-gentium-basic
RUN /docker-apt-get-install.sh fonts-stix
